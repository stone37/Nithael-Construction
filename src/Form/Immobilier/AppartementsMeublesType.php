...
class AppartementsMeublesType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('surfaceBalcon', IntegerType::class, ['label' => 'Surface du balcon en (m²) (facultatif)', 'required' => false])k
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'validation_groups' => ['Default', 'APPARTEMENT']
        ]);
    }
